    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-sm-9">
          <h2 style=" color: white;">Navigate Your Career Path, Online</h2>
		  <h4 style=" color: white;">Welcome to the Opportunity Junction where career opportunities! Dive into a world of endless possibilities as you browse through our curated job listings, connect with industry leaders, and unleash your potential.
		  Our user-friendly interface, comprehensive job listings, and cutting-edge search filters streamline your search process. Start exploring, start applying, and let your career soar to new heights with us.</h4>
