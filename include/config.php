...
$web_root = str_replace(array($doc_root, "/home/site/wwwroot/Opportunityjunc/include/config.php"), '', $this_file);
$server_root = str_replace("/home/site/wwwroot/Opportunityjunc/include/config.php", '', $this_file);
